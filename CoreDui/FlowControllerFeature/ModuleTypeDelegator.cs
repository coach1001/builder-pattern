...
{
    public class ModuleTypeDelegator<TAttribute> : TypeDelegator where TAttribute : ModuleDelegationType
    {
        private readonly TAttribute _attribute;
        private readonly TypeInfo _delegatingType;

        public ModuleTypeDelegator(TypeInfo delegatingType, TAttribute attribute)
